...
PanelWindow {
    ...
    Process {
        id: appPoller
        command: ["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/dock_backend.sh get"]
    ...
    function toggleApp(appName) {
        ...
        Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/dock_backend.sh toggle '" + safeName + "'"]);
    }
