...
UPDATER_SCRIPT="$HOME/.config/quickshell/v2/components/ilyamiro/calendar/schedule/get_schedule.py"
SHELL_NIX="$HOME/.config/quickshell/v2/components/ilyamiro/calendar/schedule/shell.nix"
