...
PanelWindow {
    ...
    Connections {
        ...
        function onRawEvent(event) {
            let n = event.name;
            if (n === "workspace" || n === "focusedmon" || n === "activewindow" || n === "createwindow" || n === "closewindow" || n === "movewindow" || n === "destroyworkspace") {
                if (!wsPoller.running) wsPoller.running = true;
            }
        }
    }
    ...
    Process {
        id: wsPoller
        command: ["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/workspaces.sh --once"]
    ...
    // Fallback slow poll just in case Hyprland events are missed
    Timer { interval: 2000; running: true; repeat: true; onTriggered: { if (!wsPoller.running) wsPoller.running = true; } }
    ...
    Process {
        id: musicPoller
        command: ["bash", "-c", "cat /tmp/music_info.json 2>/dev/null || bash ~/.config/quickshell/v2/components/ilyamiro/music/music_info.sh"]
        stdout: StdioCollector {
            onStreamFinished: {
                let txt = this.text.trim();
                if (txt !== "") {
    ...
    Process {
        id: slowSysPoller
        command: ["bash", "-c", `
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --wifi-status)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --wifi-icon)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --wifi-ssid)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --bt-status)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --bt-icon)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --bt-connected)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --battery-percent)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --battery-icon)"
        `]
        stdout: StdioCollector {
            onStreamFinished: {
    ...
    Process {
        id: fastSysPoller
        command: ["bash", "-c", `
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --volume)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --volume-icon)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --kb-layout)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/sys_info.sh --is-muted)"
        `]
        stdout: StdioCollector {
            onStreamFinished: {
                let lines = this.text.trim().split("\n");
    ...
    Process {
        id: weatherPoller
        command: ["bash", "-c", `
            echo "$(~/.config/quickshell/v2/components/ilyamiro/calendar/weather.sh --current-icon)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/calendar/weather.sh --current-temp)"
            echo "$(~/.config/quickshell/v2/components/ilyamiro/calendar/weather.sh --current-hex)"
        `]
        stdout: StdioCollector {
            onStreamFinished: {
                let lines = this.text.trim().split("\n");
    ...
    Item {
                    ...
                    Repeater {
                        ...
                        delegate: Rectangle {
                            ...
                            MouseArea {
                                ...
                                hoverEnabled: true
                                anchors.fill: parent
                                onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh " + modelData.id])
                            }
                        }
                    }
                }
                ...
                Item {
                    ...
                    RowLayout {
                        ...
                        MouseArea {
                            ...
                            hoverEnabled: true
                            onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh toggle music"])
        ...
        Rectangle {
            ...
            MouseArea {
                ...
                anchors.fill: parent
                hoverEnabled: true
                onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh toggle calendar"])
            }
            ...
            Rectangle {
                ...
                RowLayout {
                    ...
                    Rectangle {
                        ...
                        MouseArea { id: wifiMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh toggle network wifi"]) }
                    }
                    ...
                    Rectangle {
                        ...
                        MouseArea { id: btMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh toggle network bt"]) }
                    }
                    ...
                    Rectangle {
                        ...
                        MouseArea { id: batMouse; hoverEnabled: true; anchors.fill: parent; onClicked: Quickshell.execDetached(["bash", "-c", "~/.config/quickshell/v2/components/ilyamiro/qs_manager.sh toggle battery"]) }
                    }
                }
            }
        }
