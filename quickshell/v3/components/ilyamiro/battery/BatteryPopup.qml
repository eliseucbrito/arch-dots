        ...
        Rectangle {
            ...
            ColumnLayout {
                ...
                RowLayout {
                    ...
                    Repeater {
                        model: ListModel {
                            ListElement { lbl: "Lock"; cmd: "quickshell -p ~/.config/quickshell/v2/components/ilyamiro/Lock.qml"; icon: ""; c1: "#cba6f7"; c2: "#f5c2e7"; weight: 1.0 }
                            ListElement { lbl: "Sleep"; cmd: "quickshell -p ~/.config/quickshell/v2/components/ilyamiro/Lock.qml & systemctl suspend"; icon: "ᶻ 𝗓 𐰁"; c1: "#89b4fa"; c2: "#74c7ec"; weight: 1.0 }
